...
function gridSystemGenerator() {
	$(".lyrow .preview input").bind("keyup", function() {
		var e = 0;
		var t = "";
		var n = $(this).val().split(" ", 25);
		$.each(n, function(n, r) {
			e = e + parseInt(r);
			t += '<div class="g-' + r + ' column"></div>'
		});
		if (e == 25) {
...
function downloadLayoutSrc() {
	...
	$("#download-layout .row-fluid").removeClass("clearfix").children().removeClass("column");
		changeStructure("row-fluid", "g-row");
...
$(document).ready(function() {
	...
	$("#edit").click(function() {
		$("body").toggleClass("devpreview sourcepreview");
		$("body").toggleClass("edit");
		removeMenuClasses();
		var text=$(this).html();
		if(text.indexOf("edit")!=-1){
			$(this).html('<i class="icon-eye-open icon-white"></i>预览');
		}else{
	...
	$("#fixedPage").click(function(e) {
		e.preventDefault();
var obj=$(".demo").find("[data-style]");
var s='';
obj.each(function (index, elem) {
	s+=obj.attr("data-style");
});
$("#fluidPage").removeClass("active");
$(this).addClass("active");
$("#downloadModal textarea").empty();
$("#downloadModal textarea").val(s);
